...
<body id="body" style="display:flex; align-items: center;justify-content: center;height: 100vh;">
    ...
    <div id="btn" style="width:30%;">
        <h1 style="text-align: center;color:#de2f32"></h1>
        <center>
            <audio loop autoplay>
               
                <iframe src="https://www.nhaccuatui.com/mh/background/f32o3Q4f6Q"  allowfullscreen allow="autoplay"></iframe>
            </audio>
        </center>
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 150 88.4" enable-background="new 0 0 150 88.4" xml:space="preserve" style="fill: rgb(0, 0, 0);" role="img" aria-label="Valentine Envelope Line Icon">
            ...
            <h1 style="text-align: center;color:#de2f32">Giờ thì mở bức thư đầy sự đáng yêu này nào !!!</h1>
    </div>
   
   <div class="christmas" >
    <div class="message">
        <h1>Merry Christmas Đồng Dao-er!</h1>
        <h3>Đông ấm áp, đêm dịu dàng!</h3>
        <h2>From cô pé hướng nội Mỹ Trân with LOVE♥</h2>
    </div>
    <div class="window ">
        <div class="santa">
            <div class="head">
